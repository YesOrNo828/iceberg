 ...
 */
public class KrbSinkExample {
  private static final Logger LOG = LoggerFactory.getLogger(KrbSinkExample.class);
  ...
  public static void main(String[] args) throws Exception {
    ...
    String confDir = KerberosLoginUtil.copyFiles(classpathInJar, "hdfs-site.xml", "core-site.xml");
...
//    String principal = "sloth/dev@BDMS.163.COM";
    String principal = "bdms_yexianxun/dev@BDMS.163.COM";
